...
- Include the current calendar year (${currentYear}) when relevant for time-sensitive content
...
3. topic_title:
   ...
   - Format: "[Primary Keyword] [${currentYear}]: [Value Proposition]" or "[Action] [Primary Keyword] [${currentYear}]"
...
12. our_competitive_advantage: Specific, actionable plan to beat competitor (e.g., "latest data, interactive calculator, expert quotes, video comparisons")
  ...
  createFallbackTopics(approvedGaps, modelUsed) {
    ...
    const topicTemplates = [
      {
        ...
        title: `Index Funds vs Mutual Funds: Complete ${currentYear} Guide`,
      ...
      },
      {
        ...
        title: `Small Cap vs Mid Cap vs Large Cap: ${currentYear} Analysis`,
    ...
    topicTemplates.forEach((template, index) => {
      ...
      fallbackTopics.push({
        ...
        secondary_keywords: `${template.keyword} ${currentYear},${template.category.replace('_', ' ')} guide,investment comparison`,
